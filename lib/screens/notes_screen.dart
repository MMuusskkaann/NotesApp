    ...
    showDialog(
        ...
        builder: (dialogContext) {
          return NoteDialogue(
              ...
              content: content,
              onNoteSaved:
                  (newtitle, newDesription, currentDate,selectedColorIndex) async {
                if (id == null) {
                  await NotesDatabase.instance.addNotes(
                      newtitle, newDesription, currentDate, selectedColorIndex,colorIndex);
                } else {
                  await NotesDatabase.instance.updateNote(
                      newtitle, newDesription, currentDate, selectedColorIndex, id);
                }
              });
        });
  }
